...
-   Package [Uno](https://cran.r-project.org/web/packages/Uno/index.html)
    integrates the C++ solver 'Uno' for smooth nonlinearly constrained optimization.
    It unifies Lagrange-Newton methods, including sequential quadratic programming 
    and interior-point methods, by decomposing them into interacting building blocks.
